...
public abstract class ContainerDetailsResponseMapper {
    ...
    public abstract ContainerDetailsResponse from(BaseEntity baseEntity, ContainerEntity containerEntity, Collection<String> description);
}
