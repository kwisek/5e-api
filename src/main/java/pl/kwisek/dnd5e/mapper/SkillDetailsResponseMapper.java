...
public abstract class SkillDetailsResponseMapper {
    ...
    public abstract SkillDetailsResponse from(BaseEntity baseEntity, SkillEntity skillEntity, Collection<String> description);
}
