...
public abstract class ItemDetailsResponseMapper {
    ...
    public abstract ItemDetailsResponse from(BaseEntity baseEntity, ItemEntity itemEntity, Collection<String> description);
