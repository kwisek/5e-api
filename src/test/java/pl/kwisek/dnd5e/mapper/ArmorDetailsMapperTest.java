...
class ArmorDetailsMapperTest {
    ...
    void shouldMapToResponse() {
        ...
        assertAll(
                ...
                () -> assertEquals(expected.getArmorClass(), actual.getArmorClass()),
                () -> assertEquals(expected.getStrengthRequired(), actual.getStrengthRequired()),
                () -> assertEquals(expected.getStealthDisadvantage(), actual.getStealthDisadvantage()),
